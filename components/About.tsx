...
const About = () => (
    <View style={{display:'flex', padding:'5%', backgroundColor:Color.storyCard}}>
        <Text style={{fontSize: 16, textAlign:'center', marginBottom:'1%'}}>Glyphses - A collaborative storywriting app</Text>
        ...
        <Text style={{textAlign:'left'}}>1. Begin a story with just a couple of sentences (or a whole page if you prefer)</Text>
        <Text style={{textAlign:'left'}}>2. You'll get a random story every day. Add a couple of sentences to expand it</Text>
